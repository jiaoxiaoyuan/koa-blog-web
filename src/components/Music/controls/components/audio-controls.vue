...
const { getMusicList, getCustomerMusicList, getCurrentMusicId, getCurrentMusicDetail, getCurrentMusicDesc, getIsPaused, getVolume, getCurrentTime, getDuration, getIsAutoPaly, getCurrentSchedule, getPlayModel, getPlayType, getCurrentMusicDuration, setCurrentMusicDuration } = storeToRefs(musicStore);
...
<template>
  <div class="audio-controls">
    ...
    <audio class="audio" ref="audioRef" preload="auto" crossOrigin="anonymous" :src="getCurrentMusicDetail.url" :autoplay="getIsAutoPaly"></audio>
  </div>
</template>
