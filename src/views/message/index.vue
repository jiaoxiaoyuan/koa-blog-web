...
import { returnTime, _setLocalItem, containHTML } from "@/utils/tool";
    ...
    <div class="message-body center_box">
      <div class="search-tab" @mousedown="mouseDown" @mouseleave="mouseLeave">
        ...
        <Transition enter-active-class="animate__animated animate__fadeIn" leave-active-class="animate__animated animate__fadeOut">
          <div v-if="showSearch" class="flex justify-center items-center !pb-[5px]">
              ...
              <div :style="{ backgroundColor: message.bg_color }" class="message-card animate__animated animate__fadeIn">
                ...
                <div class="bottom">
                  ...
                  <div class="flex justify-start items-center option">
                    ...
                    <div class="cursor-pointer scale !ml-[10px]" @click="comment(message)">
                      <svg-icon :color="message.color" name="comment" :width="1.1"></svg-icon>
                      <span class="!ml-[5px]">{{ message.comment_total }}</span>
                    </div>
                    <div class="cursor-pointer scale flex items-center" @click="like(message, index)">
                      <svg-icon :name="message.is_like ? 'redHeart' : 'greyHeart'" :width="1.5" class="!ml-[10px]"></svg-icon>
